...
namespace Lufia2AutoTracker.Helper.Core
{
    internal static class SelfTest
    {
        public static int Run(string? dataDirectory)
        {
            ...
            failures += Check("Mesen live map preserves validated helper-block delta", () =>
                Lufia2MemoryMap.MesenWram.Gold ==
                    Lufia2MemoryMap.Wram.Gold - Lufia2MemoryMap.MesenWram.LegacyHelperDelta &&
                Lufia2MemoryMap.MesenWram.PartyStart ==
                    Lufia2MemoryMap.Wram.PartyStart - Lufia2MemoryMap.MesenWram.LegacyHelperDelta &&
                Lufia2MemoryMap.MesenWram.InventoryStart ==
                    Lufia2MemoryMap.Wram.InventoryStart - Lufia2MemoryMap.MesenWram.LegacyHelperDelta &&
                Lufia2MemoryMap.MesenWram.CharacterBase ==
                    Lufia2MemoryMap.Wram.CharacterBase - Lufia2MemoryMap.MesenWram.LegacyHelperDelta &&
                Lufia2MemoryMap.MesenWram.EnemyStructBase ==
                    Lufia2MemoryMap.Wram.EnemyStructBase - Lufia2MemoryMap.MesenWram.LegacyHelperDelta &&
                Lufia2MemoryMap.MesenWram.SaveSelectionCursor == 0x0108);

            failures += Check("Mesen enemy and target structures use live offsets", () =>
                Lufia2MemoryMap.MesenWram.EnemyStructBase == 0x1618 &&
                Lufia2MemoryMap.MesenWram.EnemyName == 0x03 &&
                Lufia2MemoryMap.MesenWram.EnemyId == 0x53 &&
                Lufia2MemoryMap.MesenWram.EnemyCurrentHp == 0x14 &&
                Lufia2MemoryMap.MesenWram.EnemyStatus == 0x12 &&
                Lufia2MemoryMap.MesenWram.BattlePartyTargetMask == 0x00 &&
                Lufia2MemoryMap.MesenWram.BattlePartyActorMask == 0x0A &&
                Lufia2MemoryMap.MesenWram.BattleEnemyTargetFlag == 0x80);
