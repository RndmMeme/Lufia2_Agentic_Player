...
class LocalModelClient:
    ...
    def choose_intent(
        ...
        system = (
            ...
            "sword presses B; interact(null) presses A while interact(direction) presses direction+A for "
            "pushing, pickup, or directional activation. If the rationale says shoot or fire a selected "
            ...
            "its coordinate is behind you. "
            "Read navigation_map.ascii_crop, tile_buffer, spatial_correlation and the current screenshot "
            "together. Target alignment is a preference, not local path proof. A collision plus tile family "
